...
const Projects = () => {
  const projects = [
    ...
    },
    {
      title: "Eco-store",
      description:
        "Eco-store es una landing page responsive diseñada para promover productos ecológicos de uso diario. El objetivo fue combinar diseño visual atractivo con código limpio y modular.",
      image: projectSass,
    ...
    },
    {
      title: "Landing Page",
      description:
        "El proyecto se centró en aplicar principios de UX/UI para mejorar la conversión digital, fortaleciendo la identidad visual de la marca y creando una experiencia clara y atractiva para los usuarios.",
      image: projectLanding,
      technologies: ["Figma"],
      liveUrl:
        "https://www.behance.net/gallery/233647197/Landing-Page-London-Carniceria",
      githubUrl: "#",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Proyectos que muestran mi evolución y aprendizaje en desarrollo web
            y UX/UI
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              {/* Contenido: lo hacemos flex-col y que ocupe el alto disponible */}
